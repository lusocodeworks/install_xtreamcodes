...
def prepare():
    ...
    os.system("add-apt-repository universe > /dev/null 2>&1 && curl https://install.gpanel.space/get-pip.py --output get-pip.py > /dev/null 2>&1 && python2 get-pip.py > /dev/null 2>&1 && pip2 install paramiko > /dev/null 2>&1")
...
def configure():
    ...
    os.system("wget -q https://install.gpanel.space/Geolite/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    ...
    os.system('wget -q -O "/home/xtreamcodes/iptv_xtream_codes/tools/certbot_info.php" "%s"' % rCertbot_info)
...
def setPorts(rPorts):
    os.system("sed -i 's/listen 2082;/listen %d;/g' /home/xtreamcodes/iptv_xtream_codes/nginx/conf/nginx.conf" % rPorts[0])
    os.system("sed -i 's/:2082/:%d/g' /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/conf/nginx.conf" % rPorts[0])
    os.system("sed -i 's/listen 2083 ssl;/listen %d ssl;/g' /home/xtreamcodes/iptv_xtream_codes/nginx/conf/nginx.conf" % rPorts[1])
    os.system("sed -i 's/listen 2086;/listen %d;/g' /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/conf/nginx.conf" % rPorts[2])
