...
rDownloadURL = {"main": "https://www.dropbox.com/s/7xcw4ymclshmv4e/main_xtreamcodes_reborn.tar.gz?dl=1", "sub": "https://www.dropbox.com/s/vdp5go2m3mieck4/sub_xtreamcodes_reborn.tar.gz?dl=1"}
...
def prepare(rType="MAIN"):
    ...
    os.system("wget -q -O /tmp/libpng12.deb https://www.dropbox.com/s/6flvrs5izbwydlz/libpng12-0_1.2.54-1ubuntu1_amd64.deb?dl=1")
...
def configure():
    ...
    os.system("sudo wget -q https://www.dropbox.com/s/dzhccw825illlbx/youtube-dl?dl=1 -O /usr/local/bin/youtube-dl")
